...
def init(w=640, h=480):
    ...
    textures = {"sun": readTex(root_directory+'/assets/sun-min.jpg'),
        "mercury":readTex(root_directory+'/assets/mercury-min.jpg'),
        "venus":readTex(root_directory+'/assets/venus-min.jpg'),
        "earth":readTex(root_directory+'/assets/earth-min.jpg'),
        "mars":readTex(root_directory+'/assets/mars-min.jpg'),
        "jupiter":readTex(root_directory+'/assets/jupiter-min.jpg'),
        "saturn":readTex(root_directory+'/assets/saturn-min.jpg'),
        "neptune":readTex(root_directory+'/assets/neptune-min.jpg'),
        "uranus":readTex(root_directory+'/assets/uranus-min.jpg'),
        "probe":readTex(root_directory+'/assets/probe.png')}
